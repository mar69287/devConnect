...
const Hero = () => {
  ...
  return (
    <Box className="hero" minH="86vh" m='0 auto' display="flex" justifyContent={"center"} alignItems="center" p={'0 1rem 0 1rem'} width={{xl: '100%', '2xl': '1400px'}}>
      <VStack >
        ...
        <Carousel width={'20rem'} infiniteLoop showArrows={false} autoPlay interval={5000} showStatus={false}  renderIndicator={renderEmptyIndicator} showThumbs={false}>
